...
-- WeakAuras/Options
	...
	L["%i Matches"] = "%i 符合"
	L["%s - Option #%i has the key %s. Please choose a different option key."] = "%s - 选项 #%i 已经有 %s 键值了，请选择一个不同的选项键值。"
	L["%s %s, Lines: %d, Frequency: %0.2f, Length: %d, Thickness: %d"] = "%s %s，线条:%d，数量:%0.2f，长度:%d，厚度:%d"
	L["%s %s, Particles: %d, Frequency: %0.2f, Scale: %0.2f"] = "%s %s，粒子:%d，数量:%0.2f，缩放:%0.2f"
	L["%s Alpha: %d%%"] = "%s 透明度:%d%%"
	L["%s Color"] = "%s 颜色"
	L["%s Default Alpha, Zoom, Icon Inset, Aspect Ratio"] = "%s 默认透明度、缩放与比例"
	L["%s Inset: %d%%"] = "%s 图标插入:%d%%"
	L["%s is not a valid SubEvent for COMBAT_LOG_EVENT_UNFILTERED"] = "%s 在 COMBAT_LOG_EVENT_UNFILTERED 中不是一个有效的子事件"
	L["%s Keep Aspect Ratio"] = "%s 保持比例不变"
	...
	L["|cFFA9A9A9--Please Create an Entry--"] = "|cFFA9A9A9--请创建一个条目--"
	L["|cFFffcc00Anchors:|r Anchored |cFFFF0000%s|r to frame's |cFFFF0000%s|r"] = "|cFFffcc00位置: |r 锚点|cFFFF0000%s|r到框体的|cFFFF0000%s|r"
	L["|cFFffcc00Anchors:|r Anchored |cFFFF0000%s|r to frame's |cFFFF0000%s|r with offset |cFFFF0000%s/%s|r"] = "|cFFffcc00位置: |r 锚点|cFFFF0000%s|r到框体的|cFFFF0000%s|r 偏移：|cFFFF0000%s/%s|r"
	L["|cFFffcc00Anchors:|r Anchored to frame's |cFFFF0000%s|r"] = "|cFFffcc00位置:|r 锚点到框体的|cFFFF0000%s|r"
	L["|cFFffcc00Anchors:|r Anchored to frame's |cFFFF0000%s|r with offset |cFFFF0000%s/%s|r"] = "|cFFffcc00位置: |r 锚点到框体的|cFFFF0000%s|r 偏移： |cFFFF0000%s/%s|r"
	L["|cFFffcc00Extra Options:|r"] = "|cFFffcc00额外选项: |r"
	L["|cFFffcc00Font Flags:|r |cFFFF0000%s|r and shadow |c%sColor|r with offset |cFFFF0000%s/%s|r %s"] = "|cFFffcc00字体样式: |r |cFFFF0000%s|r和阴影 |c%sColor|r 阴影偏移： |cFFFF0000%s/%s|r %s"
	L["|cFFffcc00Font:|r %s %s"] = "|cFFffcc00字体: |r %s %s"
	L["1 Match"] = "1符合"
...
你想要让它被放到新的|cFF22AA22动态群组|r的吗？]=]
	...
	L["Condition %i"] = "条件 %i"
	L["Conditions"] = "条件"
	L["Configure what options appear on this pannel."] = "配置那些选项在此面板上显示。"
...
UNIT_POWER, UNIT_AURA PLAYER_TARGET_CHANGED]=]
	...
	L["Determines how many entries can be in the table."] = "表中可以有多少个条目。"
	L["Differences"] = "差异"
...
|cFF00CC00大于等于 0|r 总是触发.]=]
	...
	L["If"] = "如果"
	L["If checked, then the user will see a multi line edit box. This is useful for inputting large amounts of text."] = "如果选中，则用户将看到一个多行编辑框。这对于输入大量文本很有用。"
	L["If checked, then this option group can be temporarily collapsed by the user."] = "如果选中，则用户可以临时折叠此选项组。"
	L["If checked, then this option group will start collapsed."] = "如果选中，则此选项组将默认处于折叠状态。"
	...
	L["Move Above Group"] = "移动到组上方"
	L["Move Below Group"] = "移动到组下方"
	L["Move Down"] = "向下移"
	L["Move Entry Up"] = "向上移动条目"
	L["Move Into Above Group"] = "移动到的上方的分组"
	L["Move Into Below Group"] = "移动到下方的分组"
...
只有一个单一的匹配值可以提取]=]
	...
	L["Not Loaded"] = "未载入"
	L["Number of Entries"] = "敌人数量"
	L["Offer a guided way to create auras for your character"] = "为你的角色提供引导来创造光环"
	L["Okay"] = "好"
	L["On Hide"] = "图示隐藏时触发"
	L["On Init"] = "于初始时"
	L["On Show"] = "图示显示时触发"
	...
	L["Show Border"] = "显示边框"
	L["Show Cooldown"] = "显示冷却组件"
	L["Show Extra Options"] = "显示额外的选项"
	L["Show Glow"] = "显示发光效果"
	L["Show Icon"] = "显示图标"
	...
	L["Ungroup"] = "不分组"
	L["Unit"] = "单位"
	L["Unit %s is not a valid unit for RegisterUnitEvent"] = "单位 %s 在RegisterUnitEvent中不是一个有效的单位"
	L["Unit Count"] = "单位计数"
	L["Unit Frames"] = "单位框体"
	...
	L["Use Display Info Id"] = "使用显示信息ID"
