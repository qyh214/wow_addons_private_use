...
-- WeakAuras/Options
	...
	L["|cFFFF0000Duplicate Keys Found!|nPlease change the keys of the following options!|r"] = "|cFFFF0000發現重複的 Key!|n請更改下列選項的 Key!|r"
	L["|cFFffcc00Glow:|r"] = "|cFFffcc00發光:|r"
	L["1 Match"] = "1 個符合"
	L["1. Text"] = "1.文字"
...
|cFF00CC00>= 0|r 無論如何永遠都會觸發]=]
	...
	L["Key for aura_env.config at which the user value can be found."] = "aura_env.config 的 Key (使用者的值)。"
	L["Leaf"] = "葉子"
...
只有符合這一個值的時候會被載入]=]
	...
	L["Reset all options in this group to their default values."] = "重置這個群組中的所有選項，恢復成預設值。"
	L["Reset all options to their default values."] = "重置所有選項，恢復成預設值。"
	L["Reset ALL to Defaults"] = "全部重置為預設值"
