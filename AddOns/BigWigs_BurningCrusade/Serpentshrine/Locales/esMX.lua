...
L = BigWigs:NewBossLocale("Fathom-Lord Karathress", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Leotheras the Blind", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Lurker Below", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Morogrim Tidewalker", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Lady Vashj", "esMX")
if L then
