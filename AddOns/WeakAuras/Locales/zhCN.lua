...
L["|cffeda55fRight-Click|r to toggle performance profiling on or off."] = "|cffeda55f右键|r开启/关闭性能采样。"
L["|cffeda55fShift-Click|r to pause addon execution."] = "|cffeda55fShift + 左键|r暂停插件执行。"
L["|cffeda55fShift-Right-Click|r to show profiling results."] = "|cffeda55fShift + 右键|r显示采样结果。"
