...
L["Officer"] = "幹部"
L["Offset Timer"] = "移動計時條位置"
L["Older set IDs can be found on websites such as wowhead.com/item-sets"] = "較舊的套裝 ID 可以在網站中查詢，例如 wowhead.com/item-sets"
L["On Cooldown"] = "冷卻中"
L["Only if BigWigs shows it on it's bar"] = "只有在 BigWigs 的計時條有顯示時"
L["Only if DBM shows it on it's bar"] = "只有在 DBM 的計時條有顯示時"
...
L["Player Class"] = "玩家職業"
L["Player Effective Level"] = "玩家實際等級"
...
L["Separator"] = "分隔線"
L["Set IDs can be found on websites such as classic.wowhead.com/item-sets"] = "可以在網站中找到套裝 ID，例如 classic.wowhead.com/item-sets"
...
L["Targeted"] = "已選為目標"
L["Text"] = "文字"
L["The effective level differs from the level in e.g. Time Walking dungeons."] = "實際等級和時光漫遊地城中的等級不同。"
L["The trigger number is optional, and uses the trigger providing dynamic information if not specified."] = "觸發編號是選擇性的，如果未指定的話，將會使用提供動態訊息的觸發。"
...
L["This aura was created with the retail version of World of Warcraft."] = "這個提醒效果是用魔獸世界正式版建立的。"
...
L["WeakAuras has encountered an error during the login process. Please report this issue at https://github.com/WeakAuras/Weakauras2/issues/new."] = "WA 技能提醒在登入的過程中遇到錯誤，請將這個問題回報到 https://github.com/WeakAuras/Weakauras2/issues/new"
L["WeakAuras Profiling Data"] = "WA 技能提醒設定檔資料"
L["Weapon"] = "武器"
