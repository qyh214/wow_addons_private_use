...
L["Answer"] = "Antwort"
L["A%s"] = "E%s "
L["Auto convert"] = "Automatisch Konvertieren" -- Needs review
L["Basic"] = true
...
]=] ] = "Wähle die LF-Wartenschlangen aus, in der du keine automatischen Einladungen verschicken willst." -- Needs review
...
|cFF70DBFF%s:|r Erlaube nur diejenigen, die auf der Liste sind.]=] -- Needs review
L["<command>"] = "<Befehl>"
...
L["Input"] = "Eingabe"
L["Invite player when they whisper you with a defined keyword."] = "Lade Spieler ein, wenn diese dich mit einem definierten Schlüsselwort anflüstern." -- Needs review
...
L["Maximal group size reached. Can't invite %s"] = "Kann %s nicht einladen. Maximale Gruppengröße erreicht." -- Needs review
...
L["off"] = "aus"
L["on"] = "an"
L["Pattern free matching"] = "Musterfreie Übereinstimmung" -- Needs review
L["PF "] = true -- Needs review
L["PLAYER"] = "Spieler"
...
L["Send a message to inform that you have not send an invite because your are in a LF-Queue."] = "Schicke eine Nachricht, wenn du keine Einladung schicken konntest, weil du in einer LF-Warteschlange bist. " -- Needs review
L["Send an answer"] = "Schicke eine Antwort" -- Needs review
L["%s Filter: %s"] = true
L["Show a message when a invite is blocked because of filtering."] = "Zeige eine Nachricht, wenn eine Einladung aufgrund eines Filters blockiert wurde." -- Needs review
...
L["%s was not invited: %s"] = "%s wurde nicht eingeladen: %s"
L["The message you will send."] = "Die Nachricht, welche du schicken wirst." -- Needs review
...
L["toggle"] = "wechseln"
L["Type: %s"] = "Art: %s"
L["usage"] = "Benutzung" -- Needs review
...
L["Without pattern matching."] = "Ohne Musterübereinstimmung." -- Needs review
L["You are in an instance group and not in LFR or LFG group. When you can invite here players let me know it."] = "Du bist in einer Instanzgruppe und nicht in einer LFR- or LFG-Gruppe. Falls du hier andere Spieler einladen kannst, lass es mich wissen." -- Needs review
...
L["TOC/Notes"] = "Automatisches Einladen mit Schlüsselwörtern" -- Needs review
