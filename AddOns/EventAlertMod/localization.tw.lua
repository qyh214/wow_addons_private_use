...
EA_SPELL_POWER_ECLIPSE = 8;				-- 日月蝕能（鳥D）
...
EA_XGRPALERT_POWERTYPES = {
	...
	[8]={text="日月蝕能", value=EA_SPELL_POWER_ECLIPSE},
	[9]={text="聖能", value=EA_SPELL_POWER_HOLY_POWER},
	[10]={text="真氣", value=EA_SPELL_POWER_LIGHT_FORCE},			-- 支援武僧真氣
	[11]={text="暗影寶珠", value=EA_SPELL_POWER_SHADOW_ORBS},		--5.1新增 by ZYF:加入暗影寶珠
...
EA_XSPECINFO_SHADOWORBS= "暗影寶珠";		--5.1新增 by ZYF:支援暗影寶珠、能量、怒氣、集中值
