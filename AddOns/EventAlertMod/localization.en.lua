...
EA_TTIP_SPECFLAG_CHECK_ECLIPSE = "Show Eclipse in the left 1st position of Self-Buffs";
...
EA_XOPT_SPECFLAG_SHADOWORBS = "Shadow Orbs";	--5.1 By ZYF: support display texts for Shadow Orbs, Energy, Rage, Focus.
...
EA_XOPT_SPECFLAG_BURNING_EMBERS = "Burning Embers";
EA_XOPT_SPECFLAG_DEMONIC_FURY = "Demonic Fury";
...
EA_XGRPALERT_POWERTYPES = {
	...
	[8]={text="Eclipse", value=EA_SPELL_POWER_ECLIPSE},
