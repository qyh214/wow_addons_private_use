...
EA_TTIP_SPECFLAG_CHECK_ECLIPSE = "开启/关闭, 于本身BUFF框架左侧第一格显示日月能量";
...
EA_SPELL_POWER_ECLIPSE = 8;				-- 日月蚀能（鸟D）
...
EA_XGRPALERT_POWERTYPES = {
	...
	[8]={text="日月蚀能", value=EA_SPELL_POWER_ECLIPSE},
	[9]={text="圣能", value=EA_SPELL_POWER_HOLY_POWER},
	[10]={text="真气", value=EA_SPELL_POWER_LIGHT_FORCE},			-- 支援武僧真气
	[11]={text="暗影宝珠", value=EA_SPELL_POWER_SHADOW_ORBS},		--5.1新增by ZYF:加入暗影宝珠
...
EA_XSPECINFO_SHADOWORBS= "暗影宝珠";		--5.1新增by ZYF:支援暗影宝珠、能量、怒气、集中值
