...
L["40 Player Raid Layout"] = "25人团队布局"
...
L["Adjust the spacing between individual unit frames."] = "调整独立单位框架的相隔间距。"
L["Advanced"] = "高级"
L["Advanced options."] = "高级选项。"
L["Allows mouse click through the Grid Frame."] = "是否允许透过 Grid 框架点击。"
...
L["Select which layout to use when in a 40 player raid."] = "25人团队时所选择使用的布局。"
...
L["Toggle whether to permit movement out of screen."] = "切换是否允许把窗口移到超出屏幕的位置。"
L["Top"] = "顶部"
L["Top Left"] = "左上"
L["Top Right"] = "右上"
L["Undead"] = "亡灵"
...
L["Remove an existing buff or debuff status."] = "删除状态模块内已有的一个减益"
L["Remove Aura"] = "删除增（减）益"
L["Remove %s from the menu"] = "从功能单中移除%s"
L["%s colors"] = "%s颜色"
L["%s colors and threshold values."] = "%s颜色和阈值数值。"
...
L["Set the HP % for the low HP warning."] = "设定血量百分比的低血量警报。"
...
L["Set the percentage for the low mana warning."] = "设定法力百分比的低法力警报。"
