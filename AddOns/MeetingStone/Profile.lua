...
function Profile:IsLocomotiveVersion(newVersion)
  return false
end

function Profile:SetLocomotiveVersion(version)
  self.cdb.realm.Locomotive.version = version
  self.cdb.realm.Locomotive.addnVersion = ADDON_VERSION
end

function Profile:GetLocomotiveVersion()
  return self.cdb.realm.Locomotive.version
end
