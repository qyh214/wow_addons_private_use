...
function IgnoreListPanel:OnInitialize()
    ...
    IgnoreList:SetItemList(Profile.gdb.global.UIMemory.IGNORE_LIST)
    ...
    do
        ...
        RemoveIgnore:SetScript('OnClick', function()
            for i=#Profile.gdb.global.UIMemory.IGNORE_LIST,1,-1 do
                local tb = Profile.gdb.global.UIMemory.IGNORE_LIST[i]
                tb.data = nil
                if tb.selected then
                    tb.selected = nil
