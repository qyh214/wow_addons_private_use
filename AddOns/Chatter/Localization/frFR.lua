...
L["Automatic Whisper Windows"] = "Fenêtre automatique de chuchotement"
...
L["Background Inset"] = "Encart du fond"
...
L["Class"] = "Classe"
L["Color border by channel"] = "Colorer la bordure selon le canal"
...
L["Disable server side storage of chat frame position and size."] = "Désactive l'enregistrement de la position et de la taille des fenêtre de chat sur le serveur."
...
L["Enable Scrollback length modification"] = "Active la modification de la vitesse du défilement à la molette"
...
L["Hunter"] = "Chasseur"
L["If no name can be found for an 'alt' rank character, use entire note"] = "Si aucun rang de guilde ne peut être trouvé pour un personnage, utiliser la note entière."
...
L["Look in guildnotes for character names, unless a note is set manually"] = "Recherche dans les notes de guilde pour les noms de personnages, sauf si une note est réglée manuellement."
L["LookingForGroup"] = "RechercheDeGroupe"
L["Mage"] = "Mage"
L["Make %s sticky"] = "Rend %s persistant"
...
L["Makes old text disappear rather than fade out"] = "Fait disparaître le texte ancien plutôt que de le faire disparaître progressivement."
L["Message Split"] = "Fractionnement des messages"
L["MM:SS"] = "MM:SS"
L["Module"] = "Module"
L["Modules"] = "Modules"
...
L["Requires the Alt key to be held down to move the cursor in chat"] = "Nécessite que la touche Alt soit enfoncée pour faire bouger le curseur dans le chat"
...
L["Save class data from /who queries between sessions."] = "Sauvegarder les données des classes issues des requêtes /qui entre les sessions."
...
L["Show Toast Icons"] = "Afficher les alertes Nom réel"
L["Show toast icons in the chat frames"] = "Affiche les alertes Nom réel dans la fenêtre de chat."
