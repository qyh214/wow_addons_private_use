...
L["Displays \"Enhancements\" category stats to two decimal places."] = "Отображает характеристики \"Усиления\" используя два знака после запятой."
...
L["Hides \"Enhancements\" stats if their displayed value would be zero. Checking \"Decimals\" changes the displayed value."] = "Скрыть характеристики \"Усиления\" если их отображаемое значение равно нулю. Это изменяется выбором \"Сотые\"."
L["Hides \"Enhancements\" stats only if their numerical value is exactly zero. For example, if stat value is 0.001%, then it would be displayed as 0%."] = "Скрыть характеристики \"Усиления\" только если их значение равно нулю. Например, если значение характеристики равно 0.001%, то оно будет отображаться как 0%."
