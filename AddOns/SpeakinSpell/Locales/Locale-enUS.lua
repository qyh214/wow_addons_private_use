...
-- Auto-Generated by buildlocales.py on <Tue Jul 19 20:19:02 2011>
-------------------------------------------------------------------------------
...
-- [buildlocales.py copy] ./SpeakinSpell.lua(255)
...
-- [buildlocales.py end of copy] ./SpeakinSpell.lua(271)
...
L["points"] = "points"
L["NPC"] = "NPC"
-- [buildlocales.py copy] ./substitutions.lua(351)
...
-- [buildlocales.py end of copy] ./substitutions.lua(355)
...
-- [buildlocales.py copy] ./substitutions.lua(653)
-- The wrapping symbols around <substitutions> may be localized
L["<"] = "<"
L[">"] = ">"
-- L["<(.-)>"] is a regular expression match pattern for string.gsub()
-- [buildlocales.py end of copy] ./substitutions.lua(658)
L["<(.-)>"] = "<(.-)>"
-- [buildlocales.py copy] ./substitutions.lua(672)
...
-- [buildlocales.py end of copy] ./substitutions.lua(676)
L["_(.-)_"] = "_(.-)_"
...
L["ad "] = "ad "
L["sync "] = "sync "
-- [buildlocales.py copy] ./slashcommands.lua(93)
...
-- [buildlocales.py end of copy] ./slashcommands.lua(98)
L["<newline>"] = "<newline>"
...
-- L["[Click Here]"] recycled from: ./SpeakinSpell.lua(384)
...
-- L["[/ss guides]"] recycled from: ./SpeakinSpell.lua(365)
...
-- L["Random"] recycled from: ./network.lua(564)
...
-- L["Silent"] recycled from: ./SpeakinSpell.lua(259)
-- L["<newline>"] recycled from: ./slashcommands.lua(255)
...
-- L["<"] recycled from: ./substitutions.lua(655)
...
-- L["Random Speech <number>"] recycled from: ./gui/currentmessages.lua(823)
...
-- L["Diagnostics"] recycled from: ./gui/generaloptions.lua(194)
...
-- L["SpeakinSpell Loaded"] recycled from: ./SpeakinSpell.lua(149)
-- L["<newline>"] recycled from: ./slashcommands.lua(255)
