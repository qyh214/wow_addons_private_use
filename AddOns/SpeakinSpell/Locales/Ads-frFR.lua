...
local DEFAULT_ADS = AceLocale:NewLocale("SpeakinSpell_DEFAULT_SPEECHES", "frFR", false)
if not DEFAULT_ADS then return end

local SpeakinSpell = LibStub("AceAddon-3.0"):GetAddon("SpeakinSpell")
SpeakinSpell:PrintLoading("Locales/Ads-frFR.lua")
...
DEFAULT_ADS.ADVERTISEMENTS = {
	...
	[[Do you like to distract the healer with funny chat bubbles in combat??! Doesn't everyone??! Check out SpeakinSpell: it's Manalicious! (DISCLAIMER: not responsible for raid wipes, please use responsibly)]],
