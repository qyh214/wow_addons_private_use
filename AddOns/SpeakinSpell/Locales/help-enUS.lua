...
/speakinspell sync
- send a data sharing request to GUILD, RAID, PARTY, and INSTANCE_CHAT channels
...
- For players, this will be a playable race: Human, Tauren, etc.
- For mobs and NPCs, this will be the creature type: Humanoid, Beast, etc.
...
<spellname>
- The complete name of the spell that you are casting
...
- Due to a limitation of the WoW LUA API, this substitution does not work while summoning your pet. It only works after your pet has already been summoned.

<companion>
- The name of your summoned vanity pet companion (or battle pet in MoP)
- Due to a limitation of the WoW LUA API, this substitution does not work while summoning your pet. It only works after your pet has already been summoned.

<mount>
- The name of your summoned mount
- Due to a limitation of the WoW LUA API, this substitution does not work while summoning your pet. It only works after your pet has already been summoned.
...
<scenario> 
- "The Arena", "A Battleground", "World PVP", "A Raid", etc
...
Misc. Event: Summon Mount
Misc. Event: Dismiss Mount
Misc. Event: Summon Companion Pet
Misc. Event: Dismiss Companion Pet
- Announced when you summon or dismiss your mount or companion vanity pet or battle pet
- <target> or <spellname> will supply the name of the mount or pet which was summoned or dismissed
- When summoning, <spellid> or <spelllink> will refer to the spell that summons that mount or pet
- When dismissing, the <spellid> and <spelllink> are unavailable
- Does not apply to shapeshifting, Terecgosa form, and some similar effects.
- "Companion Pets" are also known as vanity pets or battle pets in MoP.
...
The data sharing system uses invisible addon channels which are throttled to prevent lag, and limited to GUILD, RAID, PARTY, INSTANCE_CHAT, and WHISPER.
...
Thank you for using SpeakinSpell.  It's Manalicious!™ :P
]],
},
...
Translators...
- leXin for the German
- troth75 for the Korean
- contrebasse for the French 
