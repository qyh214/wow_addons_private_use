...
SpeakinSpell.DEFAULTS = {
	...
	DetectedEventStub = {
		...
		--spellid = 1234, --TODOSOON: spellid won't be optional anymore, and we want to fabricate IDs for non-spell events
		--target = "Stonarius",
		--caster = "Stonarius",
	},
	...
	DetectedEvent = {
		...
		-- table keys -- generated in Validate_DetectedEvent
		--key = "TABLEKEY",
	},
	...
	RuntimeData = {
		...
		ActiveCompanions = { -- the ActiveCompanions table is used by the COMPANION_UPDATE event
			CRITTER = nil,
			MOUNT = nil,
		},
		Recent = { 
