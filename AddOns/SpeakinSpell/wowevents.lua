...
SpeakinSpell.CombatLogEvents = {
	...
	["SPELL_AURA_REMOVED"] = function(  timestamp, eventtype, srcGUID, srcName, srcFlags, dstGUID, dstName, dstFlags, ...)
		-- buff or debuff is expiring
		SpeakinSpell:SPELL_AURA_REMOVED(timestamp, eventtype, srcGUID, srcName, srcFlags, dstGUID, dstName, dstFlags, ...)
	end,
