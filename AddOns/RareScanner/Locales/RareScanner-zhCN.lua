...
if AL then
	...
	AL["NOTE_160059"] = "他跟[监工莫迪斯]和[监工布罗塔]（普通精英）共享刷新点，如果你发现其中之一，杀了他等待稀有刷新。"
	...
	AL["NOTE_160821"] = "你需要使用[诱人的心能]点亮火盆召唤他。该物品由河边的[心蛛]掉落"
	...
	AL["NOTE_165290_4"] = "碎翼"
	AL["NOTE_166292"] = "只在世界任务[又脏又乱]中刷新"
	AL["NOTE_166393"] = "只在世界任务[脏活累活：爆破计划]中刷新"
	...
	AL["NOTE_170434"] = "他只在世界任务[唤起罪业]激活时存在。收集20个[罪碑碎片]，选择 [力量催化剂]。你会得到[罪孽融合体]来召唤他。"
	AL["NOTE_170439"] = "需要点击[远古纪念物]雕像拿到[烈阳骑士的祝福]Buff。然后使用[天行者翔翼] (格里恩盟约晋升工艺制造)飞向他才能骑上他。"
	...
	AL["NOTE_170832_4"] = "历史暮钟"
	AL["NOTE_170832_5"] = "忠诚暮钟"
	AL["NOTE_171008"] = "为了召唤他，请拉动此图标前面圆环上的1个[不稳定的回忆碎片]。 然后将他移到其他[不稳定的回忆碎片]附近。 他会吸收它们并增加[动荡]的层数。 一旦达到10层，它将变成这个稀有的NPC。"
	AL["NOTE_171010"] = "他在地下。在地下室有一个名叫[失控的爪卫]的友善NPC。你需要找到一个[被遗弃的灵豹之核]把他转变成稀有NPC。灵豹之核隐藏在这个房间或者[炉火岗哨]附近。它是一个小的蓝色圆形装置。"
	AL["NOTE_171010_1"] = "你可能会找到[被遗弃的灵豹之核]的位置"
	...
	AL["NOTE_173468_1"] = "第一天：去西部荒野北面的农村找[一捧燕麦]。"
	...
	AL["NOTE_180645"] = "你需要在炽蓝仙野找到5个[玩闹的仙狐]。他们会与你互动，你需要根据他们的动作回应相应的表情。\"开始好奇地挖掘\"：[/好奇]，“徘徊在无法坐下的地方”：[/坐下]，“独自唱歌”：[/唱歌]，“快乐地跳舞”：[/跳舞]，“孤独的坐着，黯然神伤”：[/拍]"
	...
	AL["NOTE_353325_1533"] = "你需要给他一个[熟透的莲榴]解锁宝箱（你可以在全晋升堡垒的桌子上找到）。"
	AL["NOTE_353331"] = "在屋顶，需要使用[起泡的反弹菇]到达屋顶"
	AL["NOTE_353332"] = "在树顶木头上，需要使用[起泡的反弹菇]到达顶端"
	AL["NOTE_353333"] = "在树顶，需要使用[起泡的反弹菇]到达树顶"
	...
	AL["NOTE_354647"] = "在树枝顶部。去山顶，跳到左侧的一个大树枝，从那里跳到羽毛所在的树枝。"
	AL["NOTE_354648"] = "在树中。你需要从上方进入，在[起泡的反弹菇]上跳进去。"
	AL["NOTE_354649"] = "击败[神器囤积者德米]后掉落该宝藏。"
	AL["NOTE_354650"] = "在树顶上挂在树枝的顶端。在[起泡的反弹菇]上跳上去。"
	...
	AL["NOTE_355435"] = "你需要在晋升堡垒收集50个[心能水晶碎片]。其中5个碎片在副本通灵战潮[52.88, 36.22]和副本晋升高塔[花园-46.53, 花园-69.38, 前庭-49.46] 。然后与[掌炉大师赫菲修斯]对话制作[使徒的水晶之锤]，使用它来解锁宝藏。"
	...
	AL["NOTE_355880"] = "这是成就的[死灵法典]部分。它在塔楼的顶层。你必须完成一系列给你[塔·艾兰]的任务才能打开它。"
	AL["NOTE_355880_1"] = "塔·艾兰"
	AL["NOTE_355886"] = "你需要站在绿水里获得10层[凝结魔药]后变成一个可怕的怪物。当你变成怪物时使用[管道]到达宝藏。"
	AL["NOTE_355886_1"] = "站在这边水里"
	AL["NOTE_355886_2"] = "[管道]在平台下方"
	AL["NOTE_355947"] = "在洞里。你需要击杀旁边两只非精英NPC解锁它。"
	AL["NOTE_355980"] = "收集[缺失的仪式书页]（在房间角落）并在[融合仪式之书]（在书架上）使用他们打断仪式。"
	...
	AL["NOTE_ABUSE_POWER_NPCS"] = "你需要完成从[An Abuse of Power]开始的系列任务才能击杀此NPC。然后完成可重复任务[%s]获取物品来解锁他。"
	AL["NOTE_ANIMA_CONDUCTOR"] = "需要成为[%s]盟约的一员。你需要解锁[心能导流器]并将其导向[%s]. %s"
	AL["NOTE_ASCENDED_COUNCIL_NPCS"] = "该NPC属于[晋升者议会]。 你必须在短时间（几分钟）内敲响五个钟才能开始事件。 你将会与所有圣杰作战。 当你击败他们时，[晋升宝箱]就会出现。"
	...
	AL["NOTE_KYRIAN"] = "格里恩"
	AL["NOTE_LUNARLIGHT_CONTAINERS"] = "你需要踩5个[月光花蕾]"
