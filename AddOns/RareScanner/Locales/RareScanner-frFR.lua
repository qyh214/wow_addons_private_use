...
if AL then
	...
	AL["CMD_ENABLE_ALERTS"] = "RareScanner les PNJ, les trésors et les événements rares sont désactivés"
	AL["CMD_ENABLE_CONTAINERS_ALERTS"] = "RareScanner Alertes des trésors activées"
	...
	AL["CMD_HIDE_EVENTS"] = "Désactive les icônes des événements de RareScanner sur la carte du monde"
	AL["CMD_HIDE_RARES"] = "Désactive les icônes de raresScanner des icônes rares sur la carte du monde"
	AL["CMD_HIDE_TREASURES"] = "Désactive les icônes de trésor de RareScanner sur la carte du monde"
	AL["CMD_SHOW"] = "Afficher les icônes de RareScanner sur la carte du monde"
	AL["CMD_SHOW_EVENTS"] = "Affichage des icônes d'événements de RareScanner sur la carte du monde"
	...
	AL["DISPLAY_CONTAINER_ICONS_DESC"] = "Lorsqu'elles sont désactivées, les icônes des conteneurs et des trésors ne sont pas affichées sur la carte du monde."
	...
	AL["DISPLAY_LOG_WINDOW_DESC"] = "Lorsqu'elle est désactivée, la fenêtre du journal ne s'affiche plus."
	AL["DISPLAY_LOOT_ON_MAP"] = "Afficher le butin sur les infobulles des cartes"
	...
	AL["DISPLAY_NPC_ICONS_DESC"] = "Lorsqu'elles sont désactivées, les icônes des PNJs rares ne seront pas affichées sur la carte du monde."
	AL["DISPLAY_OPTIONS"] = "Options d'affichage"
	AL["DUNGEONS_SCENARIOS"] = "Donjons / Scénarios"
	AL["ENABLE_MARKER"] = "Active l'Affichage du marqueur de cible"
	...
	AL["ENABLE_SCAN_CONTAINERS"] = "Active la recherche de trésors ou de coffres"
	...
	AL["ENABLE_SCAN_EVENTS"] = "Activer la recherche d'événements"
	...
	AL["ENABLE_SCAN_RARES"] = "Active la recherche de PNJ rares"
	...
	AL["ENABLE_SEARCHING_RARE_TOOLTIP"] = "Active les alertes pour ce rare PNJ"
	...
	AL["ENABLED_SEARCHING_RARE"] = "Active l' alerte pour ce rare PNJ :"
	AL["EVENT"] = "Événement"
	...
	AL["FILTER_ZONES_LIST_DESC"] = "Activer les alertes dans cette zone. Lorsque cette option est désactivée, vous ne recevrez pas d'alerte lorsqu'un PNJ, un événement ou un trésor rare est trouvé dans la zone."
	AL["FILTER_ZONES_ONLY_MAP"] = "Activer les filtres uniquement sur la carte du monde"
	...
	AL["JUST_SPAWNED"] = "%s vient d’apparaître. Vérifier votre carte!"
	...
	AL["LOOT_CATEGORY_FILTERS_DESC"] = "Filtrer le butin par catégorie"
	...
	AL["LOOT_FILTER_COLLECTED"] = "Filtrez les animaux domestiques, les montures et les jouets collectés."
	...
	AL["LOOT_FILTER_COMPLETED_QUEST"] = "Filtrer les éléments de quête qui ne permettent pas de commencer une nouvelle quête"
	...
	AL["LOOT_FILTER_NOT_EQUIPABLE"] = "Filtrer les éléments non équipables"
	...
	AL["LOOT_FILTER_NOT_MATCHING_CLASS"] = "Filtrez les éléments qui nécessitent une classe différente de la vôtre"
	...
	AL["LOOT_FILTER_NOT_TRANSMOG"] = "Ne montrer que les armures et les armes transmogrifiable"
	...
	AL["LOOT_OPTIONS"] = "Options des loots"
	AL["LOOT_OTHER_FILTERS"] = "Autres filtres"
	AL["LOOT_OTHER_FILTERS_DESC"] = "Autres filtres"
	AL["LOOT_PANEL_OPTIONS"] = "Options de la barre de loots"
	AL["LOOT_SUBCATEGORY_FILTERS"] = "Filtres de sous-catégories"
	AL["LOOT_TOGGLE_FILTER"] = "Alt-gauche-Clic pour activer les filtres"
	...
	AL["MAP_MENU_DISABLE_LAST_SEEN_CONTAINER_FILTER"] = "Montrez des conteneurs que vous avez vus il y a longtemps mais qui ne peuvent se reproduire"
	AL["MAP_MENU_DISABLE_LAST_SEEN_EVENT_FILTER"] = "Montrez des événements que vous avez vus il y a longtemps mais qui peuvent se reproduire"
	AL["MAP_MENU_DISABLE_LAST_SEEN_FILTER"] = "Montrez des PNJ rares que vous avez déjà vus il y a longtemps mais qui peuvent revenir"
	...
	AL["MAP_SHOW_ICON_AFTER_COLLECTED"] = "Continuer à montrer les icônes des conteneurs après le pillage"
	AL["MAP_SHOW_ICON_AFTER_COLLECTED_DESC"] = "Lorsqu'elle est désactivée, l'icône disparaîtra après le pillage du conteneur."
	AL["MAP_SHOW_ICON_AFTER_COMPLETED"] = "Continuer à afficher les icônes des événements après leur achèvement"
	...
	AL["MAP_SHOW_ICON_AFTER_DEAD"] = "Continuer à montrer les icônes du PNJ après la mort"
	...
	AL["MAP_SHOW_ICON_AFTER_DEAD_RESETEABLE"] = "Continuer à afficher les icônes des PNJ après la mort (uniquement dans les zones réinitialisables)"
	...
	AL["MAP_SHOW_ICON_CONTAINER_MAX_SEEN_TIME_DESC"] = "Définit le nombre maximum de minutes écoulées depuis que vous avez vu le conteneur. Après ce délai, l'icône ne sera pas affichée sur la carte du monde tant que vous n'aurez pas retrouvé le conteneur. Si vous sélectionnez zéro minute, les icônes s'afficheront quel que soit le temps écoulé depuis que vous avez vu le conteneur. Ce filtre ne s'applique pas aux conteneurs qui font partie d'une réalisation."
	AL["MAP_SHOW_ICON_EVENT_MAX_SEEN_TIME"] = "Minuteur pour cacher les icônes des événements (en minutes)"
	AL["MAP_SHOW_ICON_EVENT_MAX_SEEN_TIME_DESC"] = "Définit le nombre maximum de minutes écoulées depuis que vous avez vu l'événement. Après ce délai, l'icône ne sera pas affichée sur la carte du monde tant que vous n'aurez pas retrouvé l'événement. Si vous sélectionnez zéro minute, les icônes s'afficheront quel que soit le temps écoulé depuis que vous avez vu l'événement."
	AL["MAP_SHOW_ICON_MAX_SEEN_TIME"] = "Minuterie pour cacher les icônes rares des PNJ (en minutes)"
	AL["MAP_SHOW_ICON_MAX_SEEN_TIME_DESC"] = "Définit le nombre maximum de minutes écoulées depuis que vous avez vu le NPC. Après ce délai, l'icône ne sera pas affichée sur la carte du monde tant que vous n'aurez pas retrouvé le PNJ. Si vous sélectionnez zéro minute, les icônes s'afficheront quel que soit le temps écoulé depuis que vous avez vu le PNJ rare."
	...
	AL["MAP_TOOLTIP_ALREADY_OPENED"] = "Ce container est déjà ouvert. Redémarre dans : %s"
	AL["MAP_TOOLTIP_CONTAINER_LOOTED"] = "Shift-Gauche-Clic pour définir comme pillé."
	AL["MAP_TOOLTIP_DAYS"] = "jours"
	AL["MAP_TOOLTIP_EVENT_DONE"] = "Shift-Gauche-Clic pour définir comme terminé"
	AL["MAP_TOOLTIP_IGNORE_ICON"] = "Shift-Gauche-Clic pour cacher cette icône pour toujours si elle ne devrait pas être là"
	AL["MAP_TOOLTIP_KILLED"] = "Shift-Gauche-Clic pour définir comme tué"
	...
	AL["NAVIGATION_ENABLE"] = "Changer de navigation"
	...
	AL["PROFILES"] = "Profils"
	AL["RAIDS"] = "Raids"
	AL["RESET_POSITION"] = "Réinitialiser la position"
	AL["RESET_POSITION_DESC"] = "Rétablit la position initiale du bouton principal."
	AL["SHOW_CHAT_ALERT"] = "Afficher les alertes du chat"
	AL["SHOW_CHAT_ALERT_DESC"] = "Montre un message privé dans le chat à chaque apparition d'un trésor, coffre ou PNJ."
	AL["SHOW_RAID_WARNING"] = "Activer les avertissements de raid"
	...
	AL["SYNCRONIZE_DESC"] = "Cela vous permettra d'analyser les PNJs rares et les trésors qui font partie d'une réussite que vous avez déjà tués/collectés, et ils disparaîtront de votre carte. Il n'y a aucun moyen de connaître l'état des PNJs et des trésors rares qui ne font pas partie d'une réussite, donc ils resteront dans votre carte tels qu'ils sont actuellement affichés."
	...
	AL["TOC_NOTES"] = "Scanner Minimap. Vous avertit visuellement grâce à un bouton et une miniature et émet un son chaque fois qu'un PNJ, un trésor ou un événement rare apparaît dans votre minimap"
	AL["TOGGLE_FILTERS"] = "Activer les filtres"
	AL["TOGGLE_FILTERS_DESC"] = "Activer tous les filtres à la fois"
	AL["TOOLTIP_BOTTOM"] = "Partie inférieure"
	AL["TOOLTIP_CURSOR"] = "Suivi du curseur"
	AL["TOOLTIP_LEFT"] = "Côté gauche"
	AL["TOOLTIP_RIGHT"] = "Côté droit"
	AL["TOOLTIP_TOP"] = "Partie supérieure"
	AL["UNKNOWN"] = "Inconnu"
