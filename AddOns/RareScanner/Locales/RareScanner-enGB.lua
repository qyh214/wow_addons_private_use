...
if AL then
	...
	AL["NOTE_162481"] = "In order to summon him you have to interact with the [Catacombs Cache] that is inside a death golem. Once you kill him the [Catacoms Cache] will appear with loot."
	...
	AL["NOTE_165290_3"] = "Dredhaven Bolt"
	AL["NOTE_165290_4"] = "Wingsmash"
	AL["NOTE_166292"] = "He is available only during the world quest [Muck It Up]"
	AL["NOTE_166393"] = "Only available during the world quest [Dirty Job: Demolition Detail]"
	...
	AL["NOTE_167721"] = "It is hidden in the [Strange Cloud]. You won't see the NPC, but if you got the alert it is there. In order to kill him use your mount and run into the center of the cloud, then use some AOE damage and if you hit him he will show up."
	...
	AL["NOTE_168135_3"] = "Obtain [Broken Soulweb] (on top of the mountain and underneith the cart)"
	...
	AL["NOTE_170439"] = "In order to be able to ride him, use the [Ancient memorial] to get [Sunrider's Blessing]. Then use [Skystrider Glider] (crafted by leatherworkers) to reach him."
	...
	AL["NOTE_171010"] = "He is underground. Inside the chamber there is a friendly NPC named [Malfunctioning Clawguard]. You have to find a [Discarded Phalynx Core] to turn him into the rare NPC. You can find the core hidden in the same room or around the [Forgefire Outpost]. It is a small blue round looking device."
	AL["NOTE_171010_1"] = "Spot where you might find a [Discarded Phalynx Core]"
	...
	AL["NOTE_171699"] = "As soon as you approach it will dissapear, in order to reach to him, go to the beginning of the maze and follow the dots. Then you only have to defeat to [Shizgher]."
	...
	AL["NOTE_173449"] = "You can use the spell [Door of Shadows] (from [Necrolords] covenant) to reach it, but before you do, take the [Forbidden Ink] from the bottom floor (on top of a table). You will need the ink to interact with the quill."
	AL["NOTE_173468"] = "You have to assist this NPC for several days in order to complete the part [Blanchy Assisted] of the achievement. Once he spawns he remains for 5 minutes only, so be aware!."
	...
	AL["NOTE_341424_1536"] = "This is the entrace to the vault where the treasure is. Come inside for more instructions."
	...
	AL["NOTE_349793"] = "You can use the spell [Door of Shadows] (from [Necrolords] covenant) to reach it."
	...
	AL["NOTE_353325_1533"] = "In order to unlock the chest you have to bring him a [Ripe Purian] (fruit that you can find on top of tables all around Bastion)."
	...
	AL["NOTE_353650_1533"] = "Talk to [Elios] to know who is the special stewart of the day (it will appear with a red flag in the worldmap). Go to that position and give him a [Ripe Purian] (fruit that you can find on top of tables all around Bastion)."
	...
	AL["NOTE_353943_4"] = "Orb of Judgment (DON'T USE THE INCENSE)"
	...
	AL["NOTE_354647"] = "On top of a branch. Go to the top of the mountain and from there jump to the big branch that is on the left side. From this branch jump to the one where the plume is."
	...
	AL["NOTE_354651"] = "It is hanging from the top branch in the middle of the arch. You can reach it by climing the rocks on the left from behind."
	...
	AL["NOTE_355980"] = "In order to interrupt the ritual, collect [Missing Ritual Pages] and use them on the [Book of Binding Rituals]. You will get [Ritualist's Knowledge] that allows you to unlock the treasure for 5 minutes. Important! if you die or you don't reach the treasure in 5 minutes, the pages won't respawn until tomorrow!"
	AL["NOTE_355980_1"] = "Get [Missing Ritual Pages] from [Bone Pile]"
