...
if AL then
	...
	AL["NOTE_166292"] = "Solo se encuentra disponible durante la misión del mundo [Muck It Up]"
	AL["NOTE_166393"] = "Solo se encuentra disponible durante la misión del mundo [Dirty Job: Demolition Detail]"
	...
	AL["NOTE_167721"] = "Se encuentra oculto tras la [Nube extraña]]. No podrás verle, pero si has recibido la alerta es que está ahí. Para matarle utiliza tu montura y salta al centro de la nube, utiliza rapidamente cualquier hechizo de áreas del que dispongas para golpearle y que aparezca."
	...
	AL["NOTE_168135_4"] = "Completa la misión [Outplayed] (la entrega la [Dama de las Cascadas]). Se trata de una serie de misiones que empieza con [Ages-Echoing Wisdom]."
	...
	AL["NOTE_170048"] = "Para poder invocarle la misión del mundo [Swarming Souls] tiene que estar activa. Importante, ¡no completes la misión hasta que aparezca el NPC!. Mientras que la misión se encuentre activa, acerca varias [Almas perdidas] al [Ritualista declarada]."
	...
	AL["NOTE_172577"] = "Tienes que coger el [Amuleto de Eurydea] del [Eurydea's Necklace] para poder desbloquear al NPC."
	AL["NOTE_172577_1"] = "Eurydea's Necklace"
	AL["NOTE_172862"] = "Síguele hasta una cueva donde podrás atacarle."
	AL["NOTE_173449"] = "Puedes utilizar el hechizo [Puerta de las Sombras] para alcanzalo (de la curia [Necroseñores]), pero antes de hacerlo, recoge la [Tinta prohibida] de la planta inferior (se encuentra encima de la mesa). Necesitarás la tinta para poder interactuar con la pluma."
	AL["NOTE_173468"] = "Tienes que ayudar a este NPC varios días para completar la parte [Blanchy Assisted] del logro. Cuando aparece solo lo hace durante 5 minutos, ¡así que tenlo en cuenta!."
	...
	AL["NOTE_180273_3"] = "Requiere la misión del mundo [A Few Bumps Along the Way]. Obtén 2x[Curtido en combate]"
	...
	AL["NOTE_349793"] = "Puedes utilizar el hechizo [Puerta de las Sombras] para alcanzalo (de la curia [Necroseñores])."
	...
	AL["NOTE_353333"] = "Se encuentra encima del ábrol, utiliza un [Champiñón elástico] para subir."
	...
	AL["NOTE_353943_4"] = "Orbe de Sentencia (NO UTILICES EL INCIENSO)"
	...
	AL["NOTE_354275"] = "Tienes que encontrar un [Unstable Construct Anima] para desbloquearlo. Es una especie de tarro azul/morado, y se encuentra entre las cajas y tarros gigantes que hay por la zona."
	AL["NOTE_354275_1"] = "Aquí puedes encontrar un [Unstable Construct Anima]"
	...
	AL["NOTE_355980"] = "Para interrumpir el ritual tienes que obtener las [Páginas de ritual desaparecidas] y utilizarlas en el [Book of Bindings Rituals]. Obtendrás el [Conocimiento de ritualista] que te permitirá desbloquear el tesoro durante 5 minutos. ¡Cuidado!, si mueres o no alcanzas el cofre en 5 minutos las páginas no reaparecerán hasta mañana."
	AL["NOTE_355980_1"] = "Consigue las [Páginas de ritual desaparecidas] del [Montón de huesos]"
	AL["NOTE_355980_2"] = "Book of Bindings Rituals"
	...
	AL["NOTE_358298"] = "Métete en la torre y gira a la izquierda. Encima de un banco hay un [Bote de ánima], cógelo y usalo en los [Observadores silenciosos] (duendecillos amistosos que hay por la torre; utiliza \"/tar silenci\" para encontrarlos). Por último vuelve al banco donde cogiste el bote y utiliza el nuevo botón para abrir la puerta."
	...
	AL["NOTE_RUNE_CONSTRUCTS_CONTAINERS"] = "Tienes que desactivar 3x[Rune of constructs] que hay por la zona (son como baldosas en el suelo o en las paredes). Tan pronto como desactives la última el cofre se desbloqueará."
