...
if AL then
	...
	AL["NOTE_135497"] = "Доступен только во время выполнения ежедневного задания Милуны [Помощь Нордрассила]. Получив задание, вы сможете нажимать на грибы, которые находятся под деревьями. При нажатии гриб становится неподвижным. Пока он не исчез, нужно успеть нажать ещё на два гриба, чтобы появился рарник."
