...
if AL then
	...
	AL["DISPLAY_MINIMAP_ICONS"] = "Переключить значки на мини-карте"
	AL["DISPLAY_MINIMAP_ICONS_DESC"] = "При отключении вы не увидите значки на мини-карте."
	...
	AL["MAP_TOOLTIP_ADD_WAYPOINT"] = "Shift + ЛКМ, чтобы добавить путевую точку в это положение"
	...
	AL["MAP_TOOLTIP_CONTAINER_NOT_LOOTED"] = "Alt + Shift + ЛКМ, чтобы отметить как закрытый"
	...
	AL["MAP_TOOLTIP_NOT_KILLED"] = "Alt + Shift + ЛКМ, чтобы отметить живым"
	...
	AL["MAP_WAYPOINT_INGAME"] = "Переключить внутриигровые путевые точки"
	AL["MAP_WAYPOINT_INGAME_DESC"] = "Когда этот параметр включен, вы сможете добавить внутриигровую путевую точку, щелкнув Shift + ЛКМ, на значках карты мира."
	AL["MAP_WAYPOINT_TOMTOM"] = "Переключить путевые точки Tomtom"
	AL["MAP_WAYPOINT_TOMTOM_DESC"] = "Если этот параметр включен, вы сможете добавить путевую точку Tomtom, щелкнув Shift + ЛКМ, на значках карты мира."
	AL["MAP_WAYPOINTS"] = "Путевые точки"
	AL["MAP_WAYPOINTS_DESC"] = "Опции, для настройки путевых точек, добавляются при нажатии на значки карты мира."
