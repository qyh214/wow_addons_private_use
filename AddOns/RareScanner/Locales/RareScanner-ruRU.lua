...
if AL then
	...
	AL["LOOT_FILTER_NOT_EQUIPABLE"] = "Отсеять неподходящие предметы"
	AL["LOOT_FILTER_NOT_EQUIPABLE_DESC"] = "Когда включена, на панели добычи не будут показаны броня и оружие, не подходящие для вашего персонажа. Не влияет на любые другие виды предметов."
	...
	AL["MAP_MENU_DISABLE_LAST_SEEN_FILTER"] = "Показывать редких НИП которые вам попадались, но могут уже появиться снова."
	...
	AL["MARKER"] = "Маркировка цели"
	AL["MARKER_DESC"] = "Выбери значок, что повеситься на вашу цель при её выборе."
	...
	AL["NOTE_151884"] = "Доступен только во время выполнения ежедневного задания Милуны [Помощь Нордрассила]. Получив задание, вы сможете нажимать на грибы, которые находятся под деревьями. При нажатии гриб становится неподвижным. Пока он не исчез, нужно успеть нажать ещё на два гриба, чтобы появился рарник."
