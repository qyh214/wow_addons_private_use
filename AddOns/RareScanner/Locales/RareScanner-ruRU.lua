...
if AL then
	...
	AL["LOOT_FILTER_NOT_EQUIPABLE_DESC"] = "Если настройка отключена, на панели добычи не будут показаны броня и оружие, не подходящие для вашего персонажа. Не влияет на любые другие виды предметов."
	...
	AL["LOOT_TOGGLE_FILTER"] = "Нажмите, чтобы переключить фильтр"
