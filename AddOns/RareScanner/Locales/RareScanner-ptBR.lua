...
if AL then
	...
	AL["DISPLAY_MAP_ICONS"] = "Mostrar ícones no mapa mundo "
	AL["DISPLAY_MAP_ICONS_DESC"] = "Quando desativado, ícones de PNJs, recipientes ou eventos não serão mostrados no mapa mundo"
	...
	AL["MAP_MENU_SHOW_ALL"] = "Mostrar ícones no mapa"
