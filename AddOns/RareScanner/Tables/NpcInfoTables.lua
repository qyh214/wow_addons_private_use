...
private.NPC_INFO = {
	...
	[172182] = { zoneID = 1644, artID = { 1398 }, x = 0.33400002, y = 0.308, overlay = { "0.33-0.30","0.34-0.34","0.35-0.36","0.36-0.36","0.37-0.34","0.37-0.32","0.37-0.33","0.37-0.35","0.38-0.34","0.38-0.37","0.38-0.33","0.38-0.35","0.39-0.34","0.39-0.36","0.39-0.35","0.42-0.32" }, displayID = 97879 }; --Venthyr Provocateur
	...
	[161310] = { zoneID = 1525, artID = { 1306 }, x = 0.438, y = 0.50200003, overlay = { "0.43-0.50","0.44-0.51","0.42-0.49","0.43-0.49","0.43-0.52","0.42-0.51","0.42-0.48","0.43-0.51" }, displayID = 94521, questID = { 58441 } }; --Executioner Adrastia
	...
	[170439] = { zoneID = 1533, artID = { 1321 }, x = 0.6097957, y = 0.7887723, overlay = { "0.61-0.95","0.61-0.89","0.61-0.90","0.59-0.95","0.60-0.95","0.61-0.9","0.61-0.92","0.61-0.94","0.61-0.87","0.62-0.87","0.62-0.84","0.62-0.85","0.62-0.82","0.58-0.96","0.60-0.79","0.61-0.79","0.61-0.91","0.61-0.93","0.61-0.80","0.61-0.86","0.62-0.81","0.62-0.83","0.62-0.86","0.60-0.78" }, displayID = 94295 }; --Sundancer
	...
	[170932] = { zoneID = 1533, artID = { 1321 }, x = 0.5104179, y = 0.5821805, overlay = { "0.49-0.59","0.50-0.59","0.50-0.58","0.49-0.58","0.49-0.56","0.5-0.59","0.50-0.57","0.51-0.58" }, displayID = 95116, questID = { 60978 } }; --Cloudfeather Guardian
	...
	[159105] = { zoneID = 1536, artID = { 1323 }, x = 0.5002524, y = 0.23834491, overlay = { "0.49-0.22","0.48-0.23","0.49-0.23","0.48-0.24","0.49-0.24","0.50-0.25","0.46-0.24","0.47-0.24","0.48-0.25","0.48-0.22","0.49-0.19","0.49-0.21","0.5-0.21","0.5-0.24","0.50-0.24","0.50-0.26","0.50-0.22","0.51-0.27","0.50-0.23" }, displayID = 94041, questID = { 58005 } }; --Collector Kash
	...
	[162588] = { zoneID = 1536, artID = { 1323 }, x = 0.57601506, y = 0.51456106, overlay = { "0.57-0.52","0.57-0.50","0.56-0.51","0.57-0.51","0.56-0.49","0.56-0.50" }, displayID = 94882, questID = { 58837 } }; --Gristlebeak
	[162669] = { zoneID = 1536, artID = { 1323 }, x = 0.45739776, y = 0.27044156, overlay = { "0.44-0.28","0.45-0.28","0.44-0.29","0.45-0.27","0.45-0.30","0.45-0.26","0.44-0.27","0.45-0.25","0.46-0.26","0.46-0.27","0.44-0.26","0.46-0.28" }, displayID = 96375, questID = { 58835 } }; --Devour'us
	...
	[162727] = { zoneID = 1536, artID = { 1323 }, x = 0.5271424, y = 0.35061693, overlay = { "0.52-0.35","0.53-0.35","0.51-0.35","0.52-0.34","0.51-0.36","0.52-0.36","0.53-0.34" }, displayID = 48061, questID = { 58870 } }; --Bubbleblood
	...
	[156203] = { zoneID = 1543, artID = { 1329 }, x = 0.37141022, y = 0.44362304, overlay = { "0.37-0.44","0.35-0.42","0.36-0.41","0.36-0.43","0.36-0.44","0.37-0.45","0.35-0.44","0.35-0.43","0.34-0.41","0.34-0.42","0.36-0.45" }, displayID = 38549, questID = { 63371 } }; --Stygian Incinerator
	[157833] = { zoneID = 1543, artID = { 1329 }, x = 0.38937017, y = 0.41083232, overlay = { "0.40-0.41","0.39-0.41","0.39-0.39","0.40-0.39","0.39-0.43","0.4-0.39","0.4-0.43","0.38-0.39","0.39-0.38","0.39-0.40","0.39-0.42","0.40-0.40","0.40-0.42","0.4-0.42","0.41-0.40","0.38-0.41" }, displayID = 97331, questID = { 57469 } }; --Borr-Geth
	...
	[158278] = { zoneID = 1543, artID = { 1329 }, x = 0.46166778, y = 0.74133974, overlay = { "0.46-0.72","0.46-0.74","0.45-0.73" }, displayID = 93213, questID = { 158278 } }; --Nascent Devourer
	...
	[162849] = { zoneID = 1543, artID = { 1329 }, x = 0.16087693, y = 0.5075861, overlay = { "0.16-0.50","0.16-0.51","0.16-0.49","0.17-0.49","0.17-0.50" }, displayID = 92410, questID = { 60987 } }; --Morguliax <Lord of Decapitation>
	...
	[168693] = { zoneID = 1543, artID = { 1329 }, x = 0.28715947, y = 0.25127512, overlay = { "0.27-0.23","0.28-0.25","0.28-0.24","0.29-0.23","0.27-0.27","0.27-0.24","0.29-0.25","0.26-0.29","0.27-0.28","0.28-0.23","0.3-0.25","0.29-0.26" }, displayID = 94400, questID = { 61346 } }; --Cyrixia <The Willbreaker>
	...
	[172523] = { zoneID = 1543, artID = { 1329 }, x = 0.6045409, y = 0.64751595, overlay = { "0.6-0.65","0.59-0.63","0.60-0.64","0.59-0.65","0.59-0.64" }, displayID = 92416, questID = { 62209 } }; --Houndmaster Vasanok
	...
	[172862] = { zoneID = 1543, artID = { 1329 }, x = 0.37894258, y = 0.61383784, overlay = { "0.37-0.62","0.37-0.65","0.38-0.62","0.37-0.60","0.37-0.66","0.37-0.61","0.39-0.60","0.39-0.58","0.38-0.61","0.36-0.61","0.36-0.62","0.37-0.59","0.37-0.58","0.38-0.58","0.38-0.63","0.38-0.60","0.39-0.59" }, displayID = 94426, questID = { 61568 } }; --Yero the Skittish
	...
	[175012] = { zoneID = 1543, artID = { 1329 }, x = 0.4155957, y = 0.6392125, overlay = { "0.38-0.51","0.29-0.49","0.36-0.52","0.31-0.48","0.33-0.49","0.36-0.50","0.42-0.51","0.26-0.51","0.30-0.46","0.31-0.46","0.33-0.47","0.33-0.48","0.34-0.48","0.39-0.50","0.42-0.52","0.44-0.51","0.30-0.48","0.25-0.5","0.25-0.49","0.27-0.49","0.28-0.46","0.28-0.48","0.29-0.47","0.33-0.45","0.35-0.49","0.35-0.52","0.36-0.49","0.36-0.5","0.39-0.65","0.39-0.67","0.39-0.66","0.39-0.49","0.40-0.50","0.41-0.51","0.42-0.50","0.43-0.52","0.43-0.50","0.43-0.51","0.44-0.52","0.45-0.53","0.45-0.54","0.25-0.59","0.23-0.54","0.29-0.48","0.28-0.68","0.30-0.47","0.32-0.48","0.41-0.63" }, displayID = 100033, questID = { 62788 } }; --Ikras the Devourer
	...
	[164093] = { zoneID = 1565, artID = { 1338 }, x = 0.3289275, y = 0.44575274, overlay = { "0.32-0.44","0.36-0.48","0.47-0.40","0.57-0.29","0.58-0.29" }, displayID = 70936 }; --Macabre
	...
	[164238] = { zoneID = 1565, artID = { 1338 }, x = 0.46882313, y = 0.22115146, overlay = { "0.46-0.21","0.46-0.22","0.46-0.24","0.46-0.25","0.46-0.26","0.47-0.27","0.47-0.21","0.47-0.28","0.48-0.27","0.48-0.21","0.49-0.22","0.49-0.25","0.49-0.23","0.49-0.24","0.46-0.23","0.48-0.26","0.48-0.22" }, displayID = 94195, questID = { 59201 } }; --Deifir the Untamed
	[164391] = { zoneID = 1565, artID = { 1338 }, x = 0.50770956, y = 0.5820925, overlay = { "0.51-0.57","0.51-0.58","0.50-0.57","0.52-0.58","0.48-0.54","0.49-0.56","0.50-0.58","0.52-0.57" }, displayID = 95115, questID = { 59208 } }; --Old Ardeite
	...
	[166138] = { zoneID = 1565, artID = { 1338 }, x = 0.415, y = 0.4482, overlay = { "0.41-0.44" }, displayID = 99719, questID = { 61202 } }; --Mi'kai, As Argus, the Unmaker <A Corrupted World Soul>
	...
	[168135] = { zoneID = 1565, artID = { 1338 }, x = 0.6202847, y = 0.5085544, overlay = { "0.62-0.53","0.62-0.50","0.58-0.49","0.59-0.56","0.59-0.49","0.6-0.49","0.60-0.48","0.60-0.56","0.60-0.5","0.60-0.57","0.61-0.49","0.61-0.50","0.61-0.56","0.61-0.55","0.62-0.55","0.62-0.51","0.62-0.52","0.62-0.54","0.63-0.51","0.62-0.56" }, displayID = 94297 }; --Night Mare
	...
	[171705] = { zoneID = 1644, artID = { 1398 }, x = 0.36400002, y = 0.382, overlay = { "0.36-0.38","0.32-0.39","0.32-0.38","0.33-0.38","0.33-0.39","0.34-0.38","0.35-0.38","0.35-0.37","0.36-0.37","0.36-0.36","0.37-0.38","0.38-0.34","0.38-0.35","0.42-0.32","0.30-0.32","0.31-0.30","0.32-0.40","0.32-0.33","0.33-0.37","0.34-0.34","0.34-0.35","0.34-0.40","0.34-0.36","0.35-0.35","0.37-0.36","0.37-0.35","0.38-0.37","0.38-0.33","0.38-0.36","0.39-0.37","0.39-0.39","0.39-0.38","0.39-0.35","0.4-0.38","0.40-0.34","0.40-0.35","0.40-0.31","0.40-0.32","0.40-0.40","0.40-0.33","0.41-0.39","0.41-0.36","0.41-0.31","0.41-0.37","0.41-0.38","0.41-0.35","0.41-0.32","0.42-0.34","0.42-0.35","0.43-0.39","0.43-0.31","0.43-0.36","0.43-0.29","0.43-0.44","0.44-0.41" }, displayID = 97758 }; --Court Crusher
	[172164] = { zoneID = 1644, artID = { 1398 }, x = 0.44599998, y = 0.324, overlay = { "0.44-0.32","0.40-0.32","0.40-0.31","0.41-0.31","0.41-0.33","0.42-0.31","0.42-0.30","0.42-0.28","0.43-0.32","0.43-0.31","0.43-0.34","0.43-0.38","0.44-0.33","0.44-0.36","0.44-0.40","0.44-0.29","0.44-0.43","0.44-0.38","0.44-0.26","0.45-0.32","0.45-0.35","0.45-0.43","0.45-0.30","0.45-0.33","0.45-0.36","0.45-0.4","0.45-0.41","0.45-0.37","0.45-0.44","0.45-0.45","0.45-0.39","0.45-0.42","0.45-0.51","0.46-0.32","0.46-0.46","0.46-0.49","0.46-0.31","0.46-0.3","0.47-0.29","0.47-0.31","0.47-0.47","0.47-0.30","0.47-0.32","0.47-0.44","0.48-0.29","0.48-0.43","0.48-0.45","0.48-0.47","0.48-0.28","0.49-0.30","0.49-0.26","0.49-0.27","0.49-0.38","0.5-0.29","0.50-0.30","0.50-0.39","0.50-0.48","0.51-0.48","0.52-0.28","0.52-0.29","0.52-0.31","0.52-0.46","0.53-0.32","0.53-0.33","0.53-0.34","0.53-0.27","0.53-0.46","0.54-0.35","0.54-0.31","0.54-0.34","0.54-0.39","0.54-0.46","0.54-0.30","0.54-0.33","0.55-0.36","0.55-0.39","0.55-0.35","0.55-0.43","0.55-0.41","0.55-0.42","0.55-0.37","0.56-0.35","0.56-0.39","0.56-0.38","0.57-0.36" }, displayID = 82239 }; --Ember Skyterror
	[172180] = { zoneID = 1644, artID = { 1398 }, x = 0.488, y = 0.626, overlay = { "0.48-0.62","0.39-0.69","0.39-0.63","0.40-0.71","0.43-0.64","0.44-0.63","0.44-0.62","0.44-0.69","0.45-0.61","0.45-0.63","0.45-0.64","0.45-0.65","0.45-0.62","0.46-0.62","0.46-0.64","0.46-0.63","0.46-0.61","0.47-0.62","0.47-0.63","0.47-0.61","0.47-0.64","0.48-0.61","0.48-0.63","0.49-0.62","0.49-0.60","0.50-0.61","0.50-0.62","0.51-0.62","0.51-0.64","0.51-0.61" }, displayID = 95785 }; --Blustery Boil
	[172186] = { zoneID = 1644, artID = { 1398 }, x = 0.428, y = 0.34, overlay = { "0.42-0.34","0.43-0.35","0.41-0.31","0.42-0.35","0.43-0.34","0.43-0.32","0.43-0.33","0.44-0.33" }, displayID = 97444 }; --Knockerbock <"Premier" Party Supplies>
