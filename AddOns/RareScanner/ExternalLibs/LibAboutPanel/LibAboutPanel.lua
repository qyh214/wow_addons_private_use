...
elseif GAME_LOCALE == "deDE" then
	...
	L["Version"] = "Version"
	L["Website"] = "Webseite"
	L["Click and press Ctrl-C to copy"] = "Klicken und Strg-C drÃ¼cken zum kopieren."
	L["on"] = "von"
elseif GAME_LOCALE == "esES" or GAME_LOCALE == "esMX" then
	L["About"] = "Sobre"
	L["Author"] = "Autor"
	L["Category"] = "CategorÃ­a"
	L["Credits"] = "CrÃ©ditos"
	L["Donate"] = "Donar"
	L["Email"] = "Email"
	L["License"] = "Licencia"
...
elseif GAME_LOCALE == "ruRU" then
	L["About"] = "ÐžÐ± Ð°Ð´Ð´Ð¾Ð½Ðµ"
elseif GAME_LOCALE == "zhCN" then
	L["About"] = "å…³äºŽ"
	L["Click and press Ctrl-C to copy"] = "ç‚¹å‡»å¹¶ Ctrl-C å¤�åˆ¶"
elseif GAME_LOCALE == "zhTW" then
	L["About"] = "é—œæ–¼"
	L["Click and press Ctrl-C to copy"] = "å·¦é�µé»žæ“Šä¸¦æŒ‰ä¸‹ Ctrl-C ä»¥è¤‡è£½å­—ä¸²"
end
