...
Translate['No Stats'] = '无属性';
Translate['The favorites are ready to share:'] = '收藏夹内容已准备分享：';
Translate['Paste an import string to import favorites:'] = '粘贴导入字符串并收藏：';
Translate['Overwrite'] = '覆盖';
Translate['Successfully imported %d |4item:items;.'] = '成功导入%d件物品。';
Translate['Invalid import string.'] = '导入字符串无效。';
