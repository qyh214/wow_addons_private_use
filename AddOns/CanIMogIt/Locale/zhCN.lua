local translations = {
	...
	["Not learned."] = "未收藏",
	["Okay, I'll go log onto all of my toons!"] = "好的，我将登陆所有关于我的角色!",
	["Only show on items that can be equipped."] = "只对装备进行提示",
	["Only show on items that can be transmoggrified."] = "只对可幻化的物品进行提示",
	["Only show on items that you haven't learned."] = "只对未解锁的物品进行提示",
	...
	["Transmoggable Items Only"] = "只提示可幻化物品",
	["Unknown Items Only"] = "只提示未解锁的物品",
	["Updating appearances database."] = "更新外观数据库中",
	["Verbose Text"] = "详细提示",
}
