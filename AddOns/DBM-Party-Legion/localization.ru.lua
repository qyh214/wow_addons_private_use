...
L:SetOptionLocalization({
	RuneBehavior	= "Установить режим мода для $spell:197961",
	Icon			= "Голосовые оповещения на основе назначений иконок, соответствующих цветам рун (например, использование сигнальных ракет)",
	Entrance		= "Голосовые оповещения в зависимости от сторон света, например, если вход находится на юге, а трон - на севере",
	Minimap			= "Голосовые оповещения в зависимости от сторон света, основанных на миникарте, где трон находится на юге, а вход - на севере",
	Generic			= "Общее голосовое оповещение, которое просто говорит, что Вы стали целью. Направление не указывается"--По умолчанию
})

L:SetMiscLocalization({
	tempestModeMessage		=	"Нет последовательности бури: %s. Перепроверка через 8 сек.",
