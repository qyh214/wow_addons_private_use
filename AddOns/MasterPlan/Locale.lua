...
L == "deDE" and {
	...
	["No missions could be completed without exceeding currency caps, violating the %s setting."] = "Keine Mission konnte abgeschlossen werden, ohne Überschreitung der Einstellung: %s.",
	...
	["Require Currency Reward"] = "Benötigte Währungsbelohnung",
...
Diese Einstellung kann die vorgeschlagen Gruppen und Mission-Sortierreihenfolge beeinflussen.]=],
	["To temporarily ignore wasted currency and complete the skipped missions, right-click this button, or left-click individual missions below."] = "Um vorübergehend verschwendete Belohnung zu ignorieren und die übersprungenen Missionen abzuschließen, rechtsklick auf diese Schaltfläche oder linksklick unten auf einzelne Missionen.",
	...
	["You do not have this in your bags."] = "Du mußt dies nicht in deinen Taschen haben.",
