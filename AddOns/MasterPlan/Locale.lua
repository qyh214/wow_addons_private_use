...
L == "esES" and {
	...
	Ready = "Listo",
	["Redundant followers:"] = "Seguidores sin usar:",
...
L == "koKR" and {
	...
	["An additional random ability is unlocked when this follower reaches epic quality."] = "추종자가 영웅 등급이 되면 능력중 하나가 무작위로 추가됩니다.",
	...
	Ready = "준비 완료",
	["Redundant followers:"] = "쓰이지 않는 추종자:",
...
L == "ruRU" and {
	...
	Ready = "Готово",
	["Redundant followers:"] = "Свободные соратники",
