...
L["Choose Enemy Forces Format"] = "选择敌对进度格式"
...
L["Critter"] = "小动物"
L["Cursed Spire of Ny'alotha"] = "受诅之尼奥罗萨尖"
L["Custom"] = "自定义"
...
L["Enemy Info NPC Enemy Forces"] = "敌对进度"
L["Enemy Info NPC Enemy Forces (Teeming)"] = "敌对进度 (繁盛)"
...
L["Forces"] = "进度"
L["Forces only: 5/200"] = "只有进度: 5/200"
L["Forces+%: 5/200 (2.5%)"] = "进度+%: 5/200 (2.5%)"
L["Fortified"] = "强韧"
...
L["siegeGutterNote2"] = "G72切割者可用来算入敌对进度, 方法是靠输出伤害来选为目标, 然后触发他们身旁的步兵来秒杀掉"
L["siegeGuttersNote"] = "切割者注释:%s当玩家靠近时步兵会秒杀掉切割者. 若他们死亡时队伍中没有玩家对他们造成过伤害的话讲不会算入敌对进度"
L["Silence"] = "沉默"
L["Skittish"] = "无常"
L["Slow"] = "减速"
...
L["templeEyeNote"] = "塞塔里斯之眼%s将两个眼球带到塞塔里斯骸骨%s每放入一个眼球就给12敌对进度奖励"
