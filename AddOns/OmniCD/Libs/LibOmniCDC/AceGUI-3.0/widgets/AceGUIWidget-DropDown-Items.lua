...
do
	...
	local widgetType = "Dropdown-Item-Execute-OmniCDC"
	-- e
	local widgetVersion = 1
	...
	local function Constructor()
		...
		self.text:SetFontObject("GameFontNormalSmall-OmniCDC") -- s a can't change color here > done in dropdown.lua
...
do
	...
	local widgetType = "Dropdown-Item-Toggle-OmniCDC"
	local widgetVersion = 1
	-- e
	...
	local function Constructor()
		...
		self.text:SetFontObject("GameFontNormalSmall-OmniCDC") -- s a
