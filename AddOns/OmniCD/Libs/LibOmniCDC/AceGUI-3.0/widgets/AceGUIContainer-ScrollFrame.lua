...
local Type, Version = "ScrollFrame-OmniCDC", 1
-- e
...
local function Constructor()
	...
	local scrollbar = CreateFrame("Slider", ("AceConfigDialogScrollFrame%dScrollBar-OmniCDC"):format(num), scrollframe, "UIPanelScrollBarTemplate")
