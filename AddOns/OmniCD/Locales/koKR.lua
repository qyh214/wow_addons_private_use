...
L[ [=[%d: spellID.
%d-%d: spellID-talentID (Mark spell if talent is selected).]=] ] = "%d: 주문ID. %d-%d: 주문ID-특성ID (특성이 선택된 경우 주문을 표시합니다)."
L[ [=[%d: spellID.
%d-%d: spellID-talentID (Mark spell if talent is selected).]=] ] = "%d: 주문ID. %d-%d: 주문ID-특성ID (특성이 선택된 경우 주문을 표시합니다)."
L["[Show Numbers for Cooldowns] must be disabled in Blizzard's 'Options/Action Bars' menu."] = "블리자드 '설정/행동 단축바' 메뉴에서 [재사용 대기시간 숫자 표시]를 비활성화해야 합니다."
...
L["|cffff2020Glow and Highlights are never applied on cropped icons. \"Border\" must be enabled."] = "|cffff2020잘린 아이콘에는 반짝임과 하이라이트가 적용되지 않습니다. “테두리\"가 활성화되어 있어야 합니다."
...
L["0: Raid Frame, 1: Interrupt Bar, 2-8: Extra Bar"] = "0: 레이드 프레임, 1: 차단 바, 2-8: 추가 바"
L["2nd Row Icons (Double Row Layout)"] = "2열 아이콘(두 줄 배치)"
...
L["Addons with raid frame scaling will also cause the icons to scale."] = "레이드 프레임의 비율을 백분율로 설정하는 애드온을 사용하는 경우 아이콘의 비율도 같이 변경됩니다."
L[ [=[Adjust value until the truncate symbol [...] disappears.
|cffff20200: Disable option]=] ] = "생략 부호 [...]가 사라질 때까지 설정 값을 조정하십시오. |cffff20200: 옵션 비활성화"
L[ [=[Adjust value until the truncate symbol [...] disappears.
|cffff20200: Disable option]=] ] = "생략 부호 [...]가 사라질 때까지 설정 값을 조정하십시오. |cffff20200: 옵션 비활성화"
L["Alerts"] = "경보"
...
L["Attach to Raid Frame"] = "레이드 프레임에 부착"
...
L["Borders retain 1px width regardless of the UI scale"] = "테두리가 UI 비율에 상관없이 항상 1픽셀 너비를 유지"
L["Borders retain 1px width regardless of the UI scale. Need to reload the UI when the UI or icon scale changes"] = "테두리가 UI 비율에 상관없이 항상 1픽셀 너비를 유지. UI 또는 아이콘 비율 변경 후 UI를 새로고침 해야합니다"
L["Both"] = "둘 다"
L["BOTTOM"] = "아래"
L["BOTTOMLEFT"] = "왼쪽 아래"
L["BOTTOMRIGHT"] = "우측 아래"
...
L["Convert to additional CD bars that attach to each unit's raid frame."] = "각 유닛의 공격대 프레임에 부착하는 추가 CD바로 변환합니다."
L["Convert to Name Bar"] = "네임 바로 전환"
L["Cooldown"] = "재사용 대기시간"
L["Cooldown Remaining"] = "남은 재사용 대기시간"
L["Cooldown Timer"] = "재사용 대기시간 타이머"
L["Copy"] = "복사"
...
L["Current Unit Frame Addon"] = "사용 중인 유닛 프레임 애드온"
...
L["Display a glow animation around an icon when it is activated"] = "아이콘이 활성화되면 아이콘 주위에 반짝임 애니메이션을 표시합니다."
...
L["Fade out icons when the raid frame fades out for out of range units."] = "사거리 밖에 있는 유닛의 공격 프레임이 사라지면 아이콘도 사라집니다."
...
L["Fonts"] = "글꼴"
L["For double/triple layout, it will limit the number of icons per line"] = "두줄/세줄 배치의 경우 라인당 아이콘 수가 제한됩니다"
L["Force Disable"] = "강제 비활성화"
L["Frame"] = "프레임"
L["Freedom"] = "발풀기"
L["Glow"] = "반짝임"
L["Glow Border"] = "반짝임 테두리"
L["Glow condition can be changed from the Highlighting tab."] = "강조 표시 탭에서 반짝임 상태를 변경할 수 있습니다."
L["Glow Icons"] = "아이콘 반짝임"
...
L["Heal"] = "치유"
L["Healthstone and Demonic Gateway are added on cast"] = "시전 시 생명석과 악마의 관문이 추가됩니다."
...
L["Hide the leading spark texture."] = "주요 섬광 텍스처 숨기기"
L["Highlight"] = "강조"
...
L["Icon ID (Optional)"] = "아이콘 ID(선택 사항)"
L["Icon Opacity"] = "아이콘 불투명도"
L["Icon Position"] = "아이콘 위치"
L["Icon Scale Changed."] = "아이콘 비율이 변경 되었습니다."
L["Icon Size"] = "아이콘 크기"
...
L["Multiselect"] = "다중 선택"
L["Name Bar"] = "네임 바"
L["Name Offset X"] = "이름 X 위치 조정"
L["Name Offset Y"] = "이름 Y 위치 조정"
L["Name Scale"] = "이름 크기"
...
L["Offset X"] = "X 위치 조정"
L["Offset Y"] = "Y 위치 조정"
L["Only applies to spells that have Glow enabled in the Spells tab"] = "주문 탭에서 반짝임을 활성화한 주문에만 적용됩니다."
L[ [=[Only for talent abilities.
Current ability for this specialization will no longer be tracked while you are in the selected zone(s)]=] ] = "특성 스킬에만 해당됩니다. 선택한 영역에 있는 동안에는 이 스킬에 대한 현재 능력이 더 이상 추적되지 않습니다."
L["Override spell-type frame."] = "주문 유형 프레임을 무시합니다."
L["Override spell-type priority."] = "주문 유형의 우선순위를 무시합니다."
L["Padding"] = "간격"
L["Padding X"] = "X 간격"
L["Padding Y"] = "Y 간격"
...
L["Recharge"] = "재충전"
L["Redirect Spells"] = "반환 주문"
L["Redirect spells to the raid frame instead of removing them when this bar is disabled."] = "이 바가 비활성화되면 주문을 제거하지 않고 공격대 프레임으로 반환합니다."
L["Reload addon."] = "애드온 새로 고침."
...
L["Reverse Swipe"] = "회전 투명도 반전"
L["Reverse the cooldown swipe animation"] = "회전 애니메이션 투명도 반전"
L["RIGHT"] = "우측"
L["Row"] = "행"
...
L["Select a value lower than Breakpoint1"] = "Breakpoint1보다 낮은 값을 선택하세요"
...
L["Select the frame to use as default for each spell type."] = "각 주문 유형에 대해 기본으로 사용할 프레임을 선택하세요."
...
L["Select the highest spell priority to use as the start of the 2nd row"] = "2번째 행의 시작으로 사용할 가장 높은 주문 우선 순위를 선택하세요"
L["Select the highest spell priority to use as the start of the 3rd row"] = "3번째 행의 시작으로 사용할 가장 높은 주문 우선 순위를 선택하세요"
L["Select the icon layout"] = "아이콘 배치 선택"
...
L["Select your default party frame layout"] = "기본 파티 프레임의 배치 방향 선택"
...
L["Set the opacity of swipe animations"] = "회전 애니메이션 불투명도 설정"
...
L["Show pvp trinket only while in Battlegrounds"] = "전장에 있는 동안만 PvP 장신구 표시"
L["Show Range"] = "거리 표시"
...
L["TOPLEFT"] = "왼쪽 위"
L["TOPRIGHT"] = "오른쪽 위"
L["Trinket and Racial abilities are excluded from sorting"] = "장신구 및 종족 능력은 정렬에서 제외됩니다."
L["Trinket Items"] = "장신구 아이템"
L["Truncate Name"] = "이름 문자열 줄이기"
L["UI Scale Changed."] = "UI 비율이 변경 되었습니다."
...
L["Use ElvUI Timer"] = "ElvUI 타이머 사용"
...
L["Visibility"] = "표시"
L["Weak Purple Glow"] = "약한 보라색 반짝임"
L["You can mangage spell types for all bars from the Frame option"] = "프레임 옵션에서 모든 바에 대한 주문 유형을 관리할 수 있습니다."
L["You can override this setting on individual spells from the Spells tab."] = "주문 탭에서 개별 주문에 대해 이 설정을 재정의할 수 있습니다."
