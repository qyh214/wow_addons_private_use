...
L["0: Raid Frame, 1: Interrupt Bar, 2-8: Extra Bar"] = "0: 團隊框架，1: 斷法列，2-8: 額外技能列"
...
L["Glow"] = "發光"
L["Glow Border"] = "發光外框"
L["Glow condition can be changed from the Highlighting tab."] = "可以在「顯著標示」標籤頁面中更改發光條件。"
L["Glow Icons"] = "圖示發光"
...
L["Heal"] = "治療"
L["Healthstone and Demonic Gateway are added on cast"] = "爐石和惡魔之門會在施法時加入"
...
L["Offset X"] = "水平位置"
L["Offset Y"] = "垂直位置"
L["Only applies to spells that have Glow enabled in the Spells tab"] = "只會套用於「法術」標籤頁面中有啟用發光的法術"
...
L["Override spell-type frame."] = "覆蓋法術類型框架。"
L["Override spell-type priority."] = "覆蓋法術類型排列順序。"
L["Padding"] = "間距"
L["Padding X"] = "水平間距"
L["Padding Y"] = "垂直間距"
...
L["Recharge"] = "充能"
L["Redirect Spells"] = "重新安排法術位置"
L["Redirect spells to the raid frame instead of removing them when this bar is disabled."] = "停用此列時，將法術位置重新對齊到團隊框架而不是移除法術。"
...
L["Select a value lower than Breakpoint1"] = "選擇小於換行1的數值"
...
L["Select the frame to use as default for each spell type."] = "選擇每一種法術類型預設使用的框架。"
L["Select the group size for which you want to set the spell bar position"] = "選擇要設定技能列位置的隊伍大小"
L["Select the highest priority spell type to use as the start of the 2nd row"] = "選擇最優先用於第二排開頭的法術類型"
L["Select the highest priority spell type to use as the start of the 3rd row"] = "選擇最優先用於第三排開頭的法術類型"
L["Select the highest spell priority to use as the start of the 2nd row"] = "選擇最優先用於第二排開頭的法術"
L["Select the highest spell priority to use as the start of the 3rd row"] = "選擇最優先用於第三排開頭的法術"
...
L["Set the priority of spell types for sorting."] = "設定法術類型的優先順序，供排序使用。"
...
L["Spell ID"] = "法術 ID"
L["Spell Priority"] = "法術排列順序"
L["Spell Types"] = "法術類型"
L["Spells"] = "法術"
L["Spell-Type Priority"] = "法術類型排列順序"
L["Status Bar"] = "狀態列"
...
L["You can mangage spell types for all bars from the Frame option"] = "從「框架」選項可以管理所有技能列的法術類型"
L["You can override this setting on individual spells from the Spells tab."] = "可以在「法術」標籤頁面中的各個法術上覆蓋此設定。"
