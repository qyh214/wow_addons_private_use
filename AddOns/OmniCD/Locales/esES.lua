local L = LibStub("AceLocale-3.0"):NewLocale("OmniCD", "esES")
...
L["|cff9d9d9d * Scenarios and Outdoor Zones will use Arena settings."] = "|cff9d9d9d * Gestas y Zonas Exteriores utilizan configuración de Arena."
--[[Translation missing --]]
...
L["|cffff2020Important!|r Covenant and Soulbind Conduit data can only be acquired from group members with OmniCD installed."] = "|cffff2020Important!|r Solo se pueden adquirid datos sobre Curia y Conductos de Nexo de alma de miembros del grupo con OnmiCD instalado."
L["> 1 minute"] = "> 1 minuto"
--[[Translation missing --]]
...
L["2nd Row Icons (Double Row Layout)"] = "Iconos de segunda fila (Configuración de dos filas)"
L["2px Border"] = "Borde de 2px"
L["A new update is available. |cff99cdff(%s)"] = "Hay una actualización disponible. |cff99cdff(%s)"
L["Active"] = "Activo"
L["Active Icon Opacity"] = "Opacidad de Icono Activa"
L["Active Icon Settings"] = "Configuración de Icono Activa"
L["Add spell to Spell Alerts"] = "Añadir hechizo a Alertas de Hechizo"
...
|cffff20200: Disable option]=]
L["Alerts"] = "Alertas"
L["All user set values will be lost. Do you want to proceed?"] = "Todos los valores configurados por el usuario se perderán. ¿Quieres continuar?"
L["Always attach to Blizzard frames. By default, bars attach to whichever frame is visible, and if both are visible UF addon take precedence over Blizzard"] = "Anexar siempre a marcos de Blizzard. Por defecto, las barras se anexan a cualquier marco visible y, si ambos son visibles, el addon de Unit Frames tendrá preferencia sobre los de Blizzard."
L["Always Bottom"] = "Siempre abajo"
--[[Translation missing --]]
L["Always Show"] = "Always Show"
L["Always Show Cooldown Numbers"] = "Mostrar siempre números de cooldown"
L["Always Top"] = "Siempre Arriba"
--[[Translation missing --]]
L["Anchor"] = "Anchor"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["AOE CC"] = "AOE CC"
L["Apply 'Icons' alpha settings to the status bar"] = "Aplicar configuración de transparencia de iconos a la barra de estado"
