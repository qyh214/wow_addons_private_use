...
L["Shift-click to search for the exact name. Normal click to perform a regular search."] = "Shift-Klick, um nach dem exakten Namen zu suchen. Normaler Linksklick, um eine normale Suche durchzuführen." -- Needs review
