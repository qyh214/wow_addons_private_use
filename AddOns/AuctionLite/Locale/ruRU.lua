...
L["Bid Undercut (Fixed)"] = "\\\"Сбивать\\\" ставку (постоянно)" -- Needs review
...
L["Buyout Undercut (Fixed)"] = "\\\"Сбивать\\\" цену выкупа (постоянно)" -- Needs review
L["Buy Tab"] = "Купить"
L["Cancel"] = "Отмена"
...
Чтобы обойти эту проблему, вы можете продолжить нажимать на кнопку \"Отмена\" до тех пор, пока все нужные аукционы не будут отменены.]=] -- Needs review
...
L["Fixed amount to undercut market value for bid prices (e.g., 1g 2s 3c)."] = "Фиксированная сумма ниже рыночной стоимости (например, 1g 2s 3c)." -- Needs review
L["Fixed amount to undercut market value for buyout prices (e.g., 1g 2s 3c)."] = "Фиксированная сумма ниже рыночного выкупа (например, 1g 2s 3c)." -- Needs review
...
L["Listing %d of %d"] = "Лот %d из %d" -- Needs review
L["Listings"] = "Лоты"
...
L["Placement of tooltips in \"Buy\" and \"Sell\" tabs."] = "Размещение подсказок во вкладках \\\"Покупка\\\" и \\\"Продажа\\\"" -- Needs review
